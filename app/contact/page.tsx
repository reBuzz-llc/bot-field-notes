...
export default function Contact() {
  ...
  return (
    <main className="mx-auto max-w-4xl px-5 py-10">
      ...
      {/* The fastest way to reach a person, given as one card in the same style as everything else on
          the site: the whole surface is the link. */}
      <article className="group relative mt-8 overflow-hidden rounded-2xl border border-[#25D366]/35 bg-gradient-to-br from-[#25D366]/12 to-transparent p-5 transition-colors hover:border-[#25D366]/70 focus-within:border-[#25D366] sm:p-6">
        <div className="flex flex-wrap items-center gap-4">
          <span className="grid h-12 w-12 shrink-0 place-items-center rounded-full bg-[#25D366] text-white shadow-[0_6px_18px_-6px_rgba(37,211,102,0.9)]">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-0.5 text-sm text-muted">
              {COMPANY.phone} · usually answered the same day
            </p>
          </div>
          <span className="inline-flex shrink-0 items-center gap-1.5 rounded-full bg-[#25D366] px-4 py-2 text-sm font-semibold text-white transition-transform group-hover:translate-x-0.5">
